 ...
 */
//DONE 1. Add a for loop -- to loop through each element in the suites array
//DONE 2. INSIDE that loop, add another loop that loops through elements in the ranks array.
//DONE 3. Inside the second, nested loop, create a new array named card, which is composed of a rank and a suite. For example ['King', '♥︎'].
//DONE 4. Push that card onto the deck array. Once both loops complete running, the deck array will hold 52 elements, and each of those elements are themselves an array.
//DONE 5. Finally, pass the new deck to the shuffle() function, and return the results.
function createDeck() {
  var suites = ['♠︎', '♣︎', '♥︎', '♦︎'];
...
var shuffledDeck = shuffle(createDeck());
console.log(shuffledDeck);

//DONE 6. Call the createDeck() function and store the results in a new variable named myDeck

var myDeck = createDeck();
// console.log(myDeck);

/*DONE 7. Use a for loop to loop through the deck and list each card in the order the appear in the newly shuffled array. Use the log() method to print out a message like this, once for each card:
"7 of ♥.︎"
*/
for (var i = 0; i < shuffledDeck.length; i++) {
  console.log(shuffledDeck[i][0] + ' of ' + shuffledDeck[i][1]);
}
